 ...
 * https://github.com/PrismJS/prism/blob/5a24cbffd76d29c055808283aea6386031a1680d/components/prism-javascript.js
 */
...
javascript.insertBefore('string', {
	'hashbang': {
		pattern: /^#!.*/,
		greedy: true,
		alias: 'comment',
...
javascript.insertBefore('operator', {
	'literal-property': {
